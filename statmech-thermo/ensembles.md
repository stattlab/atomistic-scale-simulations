...
\begin{align*}
S_B&=\frac{E_B+P_B V_B-\mu_B N_B}{T}=\frac{E_T-E+P_B V_B-\mu_B N_B}{T}=-\frac{E}{T}+\text { constants } \\ & S_T&=S-\frac{E}{T}+\text { constants }
\end{align*}
...
\begin{align*}
S(E,V,N), \quad dS=\underbrace{\frac{1}{T}}_{"=p"} \underbrace{dE}_{"x"} + \frac{P}{T} dV -  \frac{\mu}{T} dN
\end{align*}
...
\rightarrow \beta &= \left(\frac{\partial \ln \Omega}{\partial E}\right)_{V,N}\\
\rightarrow \beta P &= \left(\frac{\partial \ln \Omega}{\partial V}\right)_{E,N}\\
